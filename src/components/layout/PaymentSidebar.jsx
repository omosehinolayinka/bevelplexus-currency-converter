      ...
      <ul>
        <li className={payProgress === "1" ? "active" : ''}>
          {payProgress > 1 ? (
            <React.Fragment>
              ...
              <span><Link to='/payment/dashboard/recipient'>Select recipient</Link></span>
            </React.Fragment>
          ) : (
            <React.Fragment>
        ...
        <li className={payProgress === "2" ? "active" : ''}>
          {payProgress > 2 ? (
            <React.Fragment>
              <img src='./assets/svg/green-check.svg' alt='check' />{" "}
              <span><Link to='/payment/dashboard/transfer'>Transfer details</Link></span>
            </React.Fragment>
          ) : (
            <React.Fragment>
        ...
        <li className={payProgress === "3" ? "active" : ''}>
          {payProgress > 3 ? (
            <React.Fragment>
              <img src='./assets/svg/green-check.svg' alt='check' />{" "}
              <span><Link to='/payment/dashboard/options'>Payment</Link></span>
            </React.Fragment>
          ) : (
            <React.Fragment>
        ...
        <li className={payProgress === "4" ? "active" : ''}>
          {payProgress > 4 ? (
            <React.Fragment>
              <img src='./assets/svg/green-check.svg' alt='check' />{" "}
              <span><Link to='/payment/dashboard/review'>Review</Link></span>
            </React.Fragment>
          ) : (
            <React.Fragment>
